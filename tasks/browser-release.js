...
module.exports = function(grunt){
  grunt.registerTask('release', 'bump version, publish with mvn', function(type){
    //defaults
    ...
    function setup(file, type){
      ...
      var nextVersion = semver.inc(pkg.version, type || 'patch');
      if (options.bump) {
        newVersion = semver.inc(pkg.version, type || 'patch');
        nextVersion = semver.inc(newVersion, type || 'patch');
      }
